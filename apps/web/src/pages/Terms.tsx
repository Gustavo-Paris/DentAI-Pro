  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-3xl">
        <h1 className="text-2xl sm:text-3xl font-semibold mb-6 sm:mb-8">Termos de Uso</h1>
        ...
        <div className="prose prose-sm sm:prose-base prose-neutral dark:prose-invert max-w-none space-y-6">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3">6. Conta do Usuário</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-3">7. Modificações do Serviço</h2>
            <p className="text-muted-foreground">
