...
export interface StatItem {
  ...
  value: string | number;
  /** Icon (string variant or LucideIcon) */
  icon?: IconProp;
...
// =============================================================================
// Label & Timestamp Types (Live Variant)
// =============================================================================
...
export interface StatsTimestamp {
  /** Icon (string variant or LucideIcon, defaults to 'clock') */
  icon?: IconProp;
  /** Label text */
  label: string;
...
/**
 * Shared props for variant components (excludes 'variant' prop)
 */
