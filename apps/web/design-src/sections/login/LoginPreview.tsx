...
/* ── Shared AuthLayout-style brand panel ── */
function BrandPanel() {
  return (
        ...
        <div className="w-full max-w-sm">
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex justify-end">
              <span className="text-sm text-muted-foreground underline underline-offset-4 cursor-pointer hover:text-foreground transition-colors">
                Esqueceu a senha?
              </span>
            </div>
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            Não tem uma conta?{' '}
            <span className="text-muted-foreground hover:text-foreground underline underline-offset-4 cursor-pointer transition-colors">
              Criar conta
            </span>
          </p>
        </div>
