...
- Esmalte Final: Escolher UMA ÚNICA resina de ESMALTE — WE(Palfique LX5) para resultado mais branco, OU MW(Estelite Omega) para resultado natural. ⚠️ PROIBIDO usar MW + WE juntas na alternativa (ambas são esmalte final, uma substitui a outra). ⚠️ WE NÃO corresponde a "esmalte A2E" — são shades distintas. ⚠️ PROIBIDO Trans/Trans20/Trans30/Opal/CT/GT como esmalte final — são translúcidos, NÃO são esmalte. SOMENTE shades de ESMALTE (WE, MW, A1E, A2E, W3, W4). Dentes clareados: usar W3/W4(Estelite Bianco) como opção ÚNICA de esmalte.
