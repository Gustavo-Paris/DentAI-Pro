...
INSERT INTO resin_catalog (name, manufacturer, type, indications, opacity, resistance, polishing, aesthetics, price_range, description)
...
WHERE NOT EXISTS (SELECT 1 FROM resin_catalog WHERE name = 'IPS Empress Direct BL-L' AND manufacturer = 'Ivoclar Vivadent');
...
WHERE NOT EXISTS (SELECT 1 FROM resin_catalog WHERE name = 'Estelite Sigma Quick Bianco' AND manufacturer = 'Tokuyama');
...
WHERE NOT EXISTS (SELECT 1 FROM resin_catalog WHERE name = 'Palfique LX5 WE' AND manufacturer = 'Tokuyama');
...
WHERE NOT EXISTS (SELECT 1 FROM resin_catalog WHERE name = 'Estelite Sigma Quick MW' AND manufacturer = 'Tokuyama');
