...
import { Sparkles, Shield, Zap, Palette, Eye, EyeOff } from 'lucide-react'
          ...
          <div className="animate-[fade-in-up_0.6s_ease-out_0.4s_both]">
            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <div className="flex justify-end">
                <span className="text-sm text-primary hover:text-primary/80 underline underline-offset-4 cursor-pointer transition-colors">
                  Esqueceu a senha?
                </span>
              </div>
