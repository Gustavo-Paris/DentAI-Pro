  ...
  return (
    <>
      <div className="relative section-glow-bg overflow-hidden">
        {/* Ambient glow orbs */}
        <div className="glow-orb w-72 h-72 bg-primary/15 dark:bg-primary/20 top-[-5%] right-[10%]" aria-hidden="true" />
        <div className="glow-orb glow-orb-slow glow-orb-reverse w-56 h-56 bg-[rgb(var(--accent-violet-rgb)/0.10)] dark:bg-[rgb(var(--accent-violet-rgb)/0.12)] top-[35%] left-[-8%]" aria-hidden="true" />
        <div className="glow-orb glow-orb-slow w-48 h-48 bg-primary/10 dark:bg-primary/15 bottom-[10%] right-[-5%]" aria-hidden="true" />
